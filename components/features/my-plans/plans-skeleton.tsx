      ...
      <Card className="backdrop-blur-xl bg-white/10 border-white/20 shadow-2xl">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Skeleton className="h-[220px] rounded-xl bg-white/10" />
            <div className="grid grid-cols-2 gap-2 content-start">
              {[1, 2, 3, 4].map((i) => (
                <Skeleton key={i} className="h-12 rounded-lg bg-white/10" />
              ))}
              <Skeleton className="col-span-2 h-12 rounded-lg bg-white/10" />
            </div>
          </div>
          <Skeleton className="h-[100px] w-full bg-white/10 mt-4 rounded-lg" />
        </CardContent>
      </Card>
