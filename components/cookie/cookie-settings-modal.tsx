        ...
        <div className="space-y-3 sm:space-y-4 mt-3 sm:mt-4">
          ...
          <Card>
            <CardHeader className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  <FiBarChart className="size-4 sm:size-5 text-lime-600 dark:text-lime-400 flex-shrink-0" />
                  <div className="min-w-0 flex-1">
          ...
          <Card>
            <CardHeader className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  <FiSettings className="size-4 sm:size-5 text-amber-600 dark:text-amber-400 flex-shrink-0" />
                  <div className="min-w-0 flex-1">
          ...
          {/* Privacy Notice */}
          <Card className="bg-lime-50 dark:bg-lime-950/30 border-lime-200 dark:border-lime-800">
            <CardContent className="p-4 sm:p-6 pt-4 sm:pt-6">
              <div className="flex items-start gap-2 sm:gap-3">
                <FiAlertCircle className="size-4 sm:size-5 text-lime-600 dark:text-lime-400 flex-shrink-0 mt-0.5" />
                <div className="min-w-0 flex-1">
                  <h4 className="font-semibold mb-1.5 sm:mb-2 text-sm sm:text-base text-lime-900 dark:text-lime-100">
                    {t("privacy.title")}
                  </h4>
                  <p className="text-xs sm:text-sm text-lime-800 dark:text-lime-200 leading-relaxed">
