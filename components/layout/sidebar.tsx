...
import { FiUser, FiSettings, FiFileText, FiCreditCard, FiGrid, FiLogOut, FiMenu, FiX, FiShield, FiPackage, FiTruck, FiTrendingUp, FiTag } from "react-icons/fi"
...
export function Sidebar({ 
  ...
  const menuItems = [
    ...
    {
      id: "recipes",
      label: t('menuItems.recipes.label'),
      icon: FiGrid,
      description: t('menuItems.recipes.description')
    },
    {
      id: "ingredients",
      label: t('menuItems.ingredients.label'),
      icon: FiPackage,
      description: t('menuItems.ingredients.description')
    },
    {
      id: "plates",
      label: t('menuItems.plates.label'),
      icon: FiGrid,
      description: t('menuItems.plates.description')
    },
    {
      id: "suppliers",
      label: t('menuItems.suppliers.label'),
      icon: FiTruck,
      description: t('menuItems.suppliers.description')
    },
    {
      id: "sales-records",
      label: t('menuItems.sales-records.label'),
      icon: FiTrendingUp,
      description: t('menuItems.sales-records.description')
    },
    {
      id: "price-observations",
      label: t('menuItems.price-observations.label'),
      icon: FiTag,
      description: t('menuItems.price-observations.description')
    },
    {
      id: "profile",
  ...
  const adminMenuItem = {
    id: "admin",
    label: t('menuItems.admin.label'),
    icon: FiShield,
    description: t('menuItems.admin.description')
  }

  const itemsToRender = isAdmin ? [...menuItems, adminMenuItem] : menuItems
            ...
            <div className="flex items-center space-x-3 mb-4">
              <div className="relative">
                {userAvatar ? (
                  ...
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center border-2 border-white/20">
              ...
              return (
                <Button
                  ...
                  className={`w-full justify-start h-12 px-3 transition-all duration-200 ${
                    isActive 
                      ? 'bg-gradient-to-r from-amber-400/20 to-orange-500/20 border border-white/20 text-white shadow-lg' 
