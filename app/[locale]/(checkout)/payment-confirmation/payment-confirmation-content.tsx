...
export function PaymentConfirmationContent() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col relative">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-amber-900 via-amber-800 to-lime-800 -z-10" />
      ...
      <div className="fixed inset-0 overflow-hidden -z-10">
        ...
        <div className="absolute top-1/2 left-1/2 w-40 h-40 bg-gradient-to-br from-cyan-400/10 to-lime-400/10 rounded-full blur-2xl" />
      </div>
        ...
        <Card className="w-full max-w-md backdrop-blur-xl bg-white/10 border-white/20 shadow-xl">
          ...
          <CardContent className="space-y-4 text-center">
            ...
            <div className="pt-4">
              <Link href="/dashboard">
                <Button
                  className="w-full bg-gradient-to-r from-amber-500 to-lime-500 hover:from-amber-600 hover:to-lime-600 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300"
                  size="lg"
                >
                  {t('goToDashboard')}
                </Button>
