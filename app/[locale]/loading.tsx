    ...
    <div className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative z-10 max-w-md mx-auto text-center">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="w-20 h-20 bg-gradient-to-r from-amber-500 to-lime-500 rounded-full flex items-center justify-center p-2">
        ...
        <div className="mt-6 inline-flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2">
          ...
          <span className="text-white text-sm font-medium">Tech Cuisine</span>
        </div>
      </div>
    </div>
  );
